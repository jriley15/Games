...
<html lang="en">
<head>
    <title>Code coverage report for AbstractVector.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> AbstractVector.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  lengthSq() {</span>
    const x = <span class="cstat-no" title="statement not covered" >this.x</span>
    const y = <span class="cstat-no" title="statement not covered" >this.y</span>
&nbsp;
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  rotate(</span>rads: number) {
    const cos = <span class="cstat-no" title="statement not covered" >Math.cos(rads)</span>
    const sin = <span class="cstat-no" title="statement not covered" >Math.sin(rads)</span>
&nbsp;
    const ox = <span class="cstat-no" title="statement not covered" >this.x</span>
    const oy = <span class="cstat-no" title="statement not covered" >this.y</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.x = ox * cos - oy * sin</span>
<span class="cstat-no" title="statement not covered" >    this.y = ox * sin + oy * cos</span>
&nbsp;
...
&nbsp;
   ...
   */
  round(<span class="missing-if-branch" title="else path not taken" >E</span>n = 2) {
    var p = precision[n]
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Thu May 24 2018 21:15:18 GMT-0700 (PDT)
</div>
</div>
